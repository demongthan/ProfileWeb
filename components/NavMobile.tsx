...
const NavMobile = ({showNav, closeNav}:Props) => {
  ...
  return (
    <>
      <div className={`fixed ${navOpenStyle} top-0 transform transition-all duration-500 z-[10000] left-0 right-0 bottom-0 bg-black opacity-70 w-[100vw] h-[100vh]`}>    
      </div>
      ...
      <ul className={`text-white ${navOpenStyle} fixed flex items-center flex-col justify-center h-[100%] transform transition-all duration-300 delay-300 w-[60%] bg-red-600 space-y-14 z-[10006]`}>
        ...
        <li><a className='nav__link text-[25px] sm:text-[30px]' href='#'>Project</a></li>
        <li><a className='nav__link text-[25px] sm:text-[30px]' href='#'>Contact me</a></li>
